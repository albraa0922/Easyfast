...
function AddNew() {
    ...
    ;
  return (
      <div className='addNew' style={{display:(isOpen ? "none" :"flex")}}>
        <div className='theAadd'>
            <h2>إضافة عنصر جديد</h2>
            <form className='addcont' >
                <div className='right'>
                ...
                <Button onClick={toggleMenu} className="formBut"><svg width="58" height="18" viewBox="0 0 58 18" fill="none" xmlns="http://www.w3.org/2000/svg">
