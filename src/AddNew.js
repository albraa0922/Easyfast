...
function AddNew({isopen, openForm}) {
      ...
      <div className='addNew' style={{display:(isopen ? "none" :"")}}>
        <div className='theAadd'>
            ...
            <form className='addcont' onSubmit={toggleMenu}>
                ...
                <Button  handleClick={() => openForm()} className="formBut"><svg width="58" height="18" viewBox="0 0 58 18" fill="none" xmlns="http://www.w3.org/2000/svg">
