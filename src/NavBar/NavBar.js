  ...
  return (
    <div className='navbar'> 
      <div className='navcont'>
        ...
        <div onClick={(e) => { e.stopPropagation(); toggleDropdown("message")}} className='navNot'>
          ...
          <Message openMsg={openMsg}/>
        </div>
      </div>
      <div className='menuCont'  >
        <div className='menu-icon' onClick={(e) => { e.stopPropagation(); showMenu("sidemenu")}}>
            <svg width="24" height="19" viewBox="0 0 24 19" fill="none" xmlns="http://www.w3.org/2000/svg">
              <path d="M22.9999 9.49992H9.38883M22.9999 1.33325H1.22217M22.9999 17.6666H1.22217" stroke="#909EA2" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
            </svg>
        </div>
        <div className={`phone-menu ${openSideMenu ? 'open' : ''}`}>
            <PhoneMenu showMenu={showMenu}/>
        </div>
      </div> 
    </div>
  )
